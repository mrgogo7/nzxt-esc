...
> [!IMPORTANT]
> ### การใช้งานแบบโฮสต์และการเข้าถึงสำหรับผู้สนับสนุน
>
> เวอร์ชันโฮสต์ของ NZXT-ESC มาพร้อมกับ **การใช้งานเริ่มต้นสูงสุด 100
> ชั่วโมง** เพื่อให้คุณได้ลองใช้โครงการอย่างเต็มที่ก่อนตัดสินใจว่า
> ต้องการสนับสนุนการพัฒนาต่อเนื่องของโครงการหรือไม่
>
> การถึงขีดจำกัดการใช้งานเริ่มต้น **ไม่ได้** หมายความว่าคุณจะเสียการ
> เข้าถึงทันที คุณจะมีตัวเลือกในการรับเวลาเพิ่มเติมเพื่อใช้งาน
> NZXT-ESC ต่อไปและให้เวลาตัวเองอีกสักหน่อยในการตัดสินใจ
>
> ผู้ใช้ที่เลือกสนับสนุนโครงการสามารถรับ **รหัสเข้าถึงสำหรับ
> ผู้สนับสนุน** เพื่อการใช้งานแบบโฮสต์เพิ่มเติมได้
>
> การสนับสนุนจากชุมชนช่วยครอบคลุมค่าใช้จ่ายด้านเซิร์ฟเวอร์ API
> การโฮสต์ การบำรุงรักษา และการพัฒนาอย่างต่อเนื่อง
...
<details>
<summary><strong>การใช้งานแบบโฮสต์และการเข้าถึงสำหรับผู้สนับสนุนทำงานอย่างไร?</strong></summary>

เวอร์ชันโฮสต์ของ NZXT-ESC มาพร้อมกับการใช้งานเริ่มต้นสูงสุด 100 ชั่วโมง ซึ่งให้เวลาคุณได้ลองใช้โครงการอย่างเต็มที่ก่อนตัดสินใจว่าต้องการสนับสนุนการพัฒนาต่อเนื่องของโครงการหรือไม่

การถึงขีดจำกัดการใช้งานเริ่มต้นไม่ได้ทำให้คุณเสียการเข้าถึงทันที คุณจะมีตัวเลือกในการรับเวลาตัดสินใจเพิ่มเติมและใช้งาน NZXT-ESC ต่อไปก่อนที่จะตัดสินใจ

ผู้ใช้ที่เลือกสนับสนุนโครงการสามารถรับรหัสเข้าถึงสำหรับผู้สนับสนุนเพื่อการใช้งานแบบโฮสต์เพิ่มเติมได้

โมเดลการใช้งานนี้ช่วยครอบคลุมค่าใช้จ่ายด้านเซิร์ฟเวอร์ API การโฮสต์ การบำรุงรักษา และการพัฒนาอย่างต่อเนื่อง พร้อมทั้งให้เวลาผู้ใช้เพียงพอในการทำความรู้จัก NZXT-ESC ก่อนตัดสินใจสนับสนุนโครงการ

เวลาการใช้งานจะถูกนับในขณะที่ NZXT-ESC กำลังทำงานอยู่บนหน้าจอ Kraken
