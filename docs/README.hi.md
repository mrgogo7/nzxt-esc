# NZXT-ESC - सर्वश्रेष्ठ NZXT Web Integration
...
>
> NZXT-ESC के होस्टेड संस्करण में **100 घंटे का शुरुआती उपयोग** शामिल
> है, ताकि आप यह तय करने से पहले कि आप इसके निरंतर विकास को सपोर्ट
> करना चाहते हैं या नहीं, प्रोजेक्ट को ठीक से अनुभव कर सकें।
>
> शुरुआती उपयोग सीमा तक पहुंचने का मतलब **तुरंत** एक्सेस खोना नहीं है।
> आपके पास NZXT-ESC का उपयोग जारी रखने और निर्णय लेने के लिए खुद को
> थोड़ा और समय देने हेतु अतिरिक्त समय पाने का विकल्प होगा।
>
> जो उपयोगकर्ता प्रोजेक्ट को सपोर्ट करना चुनते हैं, उन्हें अतिरिक्त
> होस्टेड उपयोग के लिए एक **Supporter Access Code** मिल सकता है।
>
...
<details>
<summary><strong>होस्टेड उपयोग और Supporter Access कैसे काम करते हैं?</strong></summary>

NZXT-ESC के होस्टेड संस्करण में 100 घंटे का शुरुआती उपयोग शामिल है, जो आपको यह तय करने से पहले कि आप इसके निरंतर विकास को सपोर्ट करना चाहते हैं या नहीं, प्रोजेक्ट को ठीक से अनुभव करने का समय देता है।

शुरुआती उपयोग सीमा तक पहुंचने से आपका एक्सेस तुरंत समाप्त नहीं होता। आपके पास निर्णय लेने के लिए अतिरिक्त समय पाने और अपना निर्णय लेने से पहले NZXT-ESC का उपयोग जारी रखने का विकल्प होगा।

जो उपयोगकर्ता प्रोजेक्ट को सपोर्ट करना चुनते हैं, उन्हें अतिरिक्त होस्टेड उपयोग के लिए एक Supporter Access Code मिल सकता है।

यह उपयोग मॉडल सर्वर, API, होस्टिंग, रखरखाव और चल रहे विकास की लागत को कवर करने में मदद करता है, साथ ही उपयोगकर्ताओं को प्रोजेक्ट को सपोर्ट करने का निर्णय लेने से पहले NZXT-ESC का अनुभव करने के लिए पर्याप्त समय देता है।
