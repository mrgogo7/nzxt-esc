...
| **बहुभाषी एडिटर** | इंटरफ़ेस को 21 समर्थित भाषाओं में उपयोग करें। |
...
<details>
<summary><strong>Supporter Access कैसे काम करता है?</strong></summary>

NZXT-ESC को स्वतंत्र रूप से विकसित और मेंटेन किया जाता है। प्रोजेक्ट को वास्तव में अनुभव करने के लिए पर्याप्त समय मिलने के बाद, NZXT-ESC आपसे पूछ सकता है कि क्या आप इसके निरंतर विकास का समर्थन करना चाहेंगे या निर्णय लेने के लिए थोड़ा और समय लेना चाहेंगे।

समर्थन का मतलब हमेशा पैसा नहीं होता। फ़ीडबैक, बग रिपोर्ट, विचार, प्रोजेक्ट को साझा करना, दूसरों को इसे खोजने में मदद करना, और सार्थक सामुदायिक योगदान के अन्य तरीके, ये सभी NZXT-ESC को आगे बढ़ने में मदद करते हैं।

Supporter Access Code प्रोजेक्ट के समर्थकों के लिए उपलब्ध हैं और उन सामुदायिक सदस्यों को भी उपहार में दिए जा सकते हैं जो NZXT-ESC में सार्थक योगदान देते हैं।
...
अगर NZXT-ESC ने आपके सेटअप में अपनी जगह बना ली है, तो प्रोजेक्ट को सपोर्ट करने के कई तरीके हैं: फ़ीडबैक और विचार साझा करें, बग रिपोर्ट करें, दूसरों को NZXT-ESC खोजने में मदद करें, समुदाय में योगदान दें - या बस मुझे एक कॉफ़ी खिलाएँ।

हर तरह का योगदान NZXT-ESC को आगे बढ़ाने में मदद करता है, जबकि कॉफ़ी सपोर्ट सर्वर, API, होस्टिंग और रखरखाव की लागत को कवर करने में मदद करता है।
